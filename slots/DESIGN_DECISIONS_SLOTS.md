...
interface, holds all the rules (a little Composite), runs them and keeps the biggest payout, and that's how
...
No fixed odds table anywhere. `ChanceCalculator` turns the machine's setup into probabilities, turning each
